          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden md:block">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search Codebyters..."
                  className="block w-64 pl-10 pr-3 py-2 border border-gray-300 rounded-full text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#20B2AA] focus:border-transparent bg-gray-50"
                />
              </div>
            </div>
          </div>
