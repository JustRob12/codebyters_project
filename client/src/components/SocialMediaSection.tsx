...
export default function SocialMediaSection({ userId, isEditing, onEditToggle }: SocialMediaSectionProps) {
        ...
        <div className="space-y-4">
          ...
          {isEditing && (
            <div className="border-t pt-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-4">Add Social Media Link</h4>
              <div className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#20B2AA] focus:border-transparent text-black bg-white"
                  >
                ...
                <button
                  ...
                  className="w-full bg-[#20B2AA] text-white py-2 px-4 rounded-lg hover:bg-[#1a9b9b] transition-colors"
                >
                  Add Link
                </button>
              </div>
